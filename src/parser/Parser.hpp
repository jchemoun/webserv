...
/*   Updated: 2022/05/25 08:12:07 by mjacq            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
	...
	const char	*_parse_address(Config::Connection &listen, const char *s);  // part of _parse_listen
	void	_parse_default_mime(Config::Server &server);                 // http://nginx.org/en/docs/http/ngx_http_core_module.html#default_type
